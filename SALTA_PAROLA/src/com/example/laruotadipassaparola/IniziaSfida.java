...
public class IniziaSfida extends Activity {

	int contatore ; int secondi ; int differenza ; int i ; int x ;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_inizia_sfida);
		...
		risposte_esatte.setText(contatore + "");
		...
		bottone_risposta.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				...
				/** L'If è necessario perchè il ciclo for presente in seguito, deve intervenire
				 *  solo nel caso in cui il while precedentemente descritto non sia riuscito a
				 *  trovare lettere con stato 3, o 0, dopo il valore di i corrente. */
		...
		bottone_salta.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				...
				/** Questo ciclo while ha lo stesso fine del while inserito nell'evento 
				 *  OnClick precedente. */
				...
				if(i >= 21){		
					...
					/** Questo ciclo for ha lo stesso fine del for inserito nell'evento 
				     *  OnClick precedente. */
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.activity_inizia_sfida, menu);
		return true;
	}
	
	/** Ora faremo un metodo che 'etichetterà' ogni Lettera a seconda se sarà risposta 
	...
	public void countdown() {	
		...
		Runnable ru = new Runnable() {
			...
			public void run() {
				...
				in = new Intent(IniziaSfida.this, TempoScaduto.class);
				in.putExtra("ESATTE", contatore) ;
				startActivity(in);
			}
		}; new Thread(ru).start();	
	} 		
