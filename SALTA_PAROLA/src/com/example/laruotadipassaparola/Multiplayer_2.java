...
public class Multiplayer_2 extends Activity {
	
	int contatore_1 ; int contatore_2 ; int secondi ; int differenza ; int i ; int x ;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_multiplayer_2);

		i = 0 ; x = 0 ; contatore_2 = 0 ; 
		...
		risposte_esatte.setText(contatore_2 + "");
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.activity_multiplayer_2, menu);
		return true;
	}
	...
	public void countdown() {	
		...
		Runnable ru = new Runnable() {
			...
			public void run() {
				...
				in = new Intent(Multiplayer_2.this, FinePartitaMultiplayer.class);
				contatore_1 = getIntent().getExtras().getInt("CONTATORE_1");
				in.putExtra("CONTATORE_2", contatore_2) ;
